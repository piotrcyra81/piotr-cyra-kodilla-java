...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://piotrcyra81.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("piotrcyra");
        driverTrello.findElement(By.id("password")).sendKeys("Lambo5822");
    ...
    public void deleteTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                        .getText().equals(taskName))
                .forEach( theForm -> {
                    WebElement deleteTaskBtn = theForm.findElement(By.xpath(XPATH));
                    deleteTaskBtn.click();
                });
