...
public class CompanyRepositoryTestSuite {
    ...
    public void testSaveManyToMany() {
        ...
        //CleanUp
        try {
            companyRepository.delete(softwareMachineId);
            companyRepository.delete(dataMaestersId);
            companyRepository.delete(greyMatterId);
        } catch (Exception e) {
            //do nothing
        }
    }
    ...
    public void testNamedQueries(){
        ...
        //When
        List<Employee> foundEmployee = employeeRepository.retrieveEmployeeWithLastname("Smith");
        List<Company> foundCompany = companyRepository.retrieveCompanyWhoseNameBegins("Sof");
